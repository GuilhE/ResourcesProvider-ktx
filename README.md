...
```groovy
implementation 'com.github.guilhe.resourcesprovider-ktx${LATEST_VERSION}'
```
[![Maven Central](https://maven-badges.herokuapp.com/maven-central/com.github.guilhe.resourcesprovider-ktx/badge.svg)](https://search.maven.org/search?q=g:com.github.guilhe.resourcesprovider-ktx) [![Download](https://api.bintray.com/packages/gdelgado/android/ResourcesProvider-ktx/images/download.svg)](https://bintray.com/gdelgado/android/ResourcesProvider-ktx/_latestVersion)
